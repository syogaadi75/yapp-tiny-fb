...
function Sidebar() {
    const {data: session, data: loading, status} = useSession()

  return (
    <div className='px-2 mt-5 max-w-[600px] xl:min-w-[300px]'>
        <SidebarRow Img={session.user.image} title={session.user.name} />
